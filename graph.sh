...
VALIDATORS="`find validators/ -name \*.js`"
...
node analyze.js --core=sink --format=deps ${VALIDATORS} >deps-validators.dot
...
dot deps-validators.dot -Tpng -o deps-validators.png
